...
@Autonomous(name = "FTCAutonomousGPP")
public class FTCAutonomousGPP extends OpMode {
    ...
    // Target: G, P, P — pile arrangements are always upper=PPG, middle=PGP, lower=GPP
    private static final double[][] SPIT_ROT = {
        {0, 240, 240},    // Pre-loaded (standard, tested)
        {240, 120, 120},  // Pile 1 - upper PPG: G(slot2), P(slot0), P(slot1)
        {120, 120, 120},  // Pile 2 - middle PGP: G(slot1), P(slot2), P(slot0)
        {0, 120, 120},    // Pile 3 - lower GPP: G(slot0), P(slot1), P(slot2) - natural
    };
    ...
    public void init() {
        ...
        telemetryM.debug("GPP Autonomous initialized.");
